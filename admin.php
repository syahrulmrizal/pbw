	...
	while($data = mysqli_fetch_array($query)){
		?>
			<tr>
				...
				<td>
					<a href="index.php?aksi=update&id=<?php echo $data['id']; ?>&nama=<?php echo $data['judul']; ?>&hasil=<?php echo $data['tanggal']; ?>&lama=<?php echo $data['foto']; ?>&tanggal=<?php echo $data['konten']; ?>">Ubah</a> |
